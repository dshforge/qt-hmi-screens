...
/*  Single source of truth for the instrument palette.
    ...
    beam. They are named here so a screen cannot quietly pick the wrong
    one, and so a homologation review has one file to read.            */
QtObject {
    // --- grounds -------------------------------------------------
